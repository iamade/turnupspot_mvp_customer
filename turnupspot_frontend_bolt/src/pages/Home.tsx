...
const Home = () => {
  return (
    <div className="px-4 sm:px-6 md:px-8 max-w-6xl mx-auto space-y-12">
      <section className="text-center py-16 bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-3xl text-white">
        <h1 className="text-4xl md:text-6xl font-bold mb-6">
          Welcome to Turnup Spot
        </h1>
        <p className="text-xl md:text-2xl mb-8">
          Your ultimate platform for events, sports, and vendor management
        </p>
        <div className="flex justify-center space-x-4">
          <Link
            to="/events/create"
            className="bg-white text-indigo-600 px-8 py-3 rounded-lg font-bold hover:bg-indigo-100"
          >
            Create Event
          </Link>
          <Link
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white p-8 rounded-xl shadow-lg">
          ...
          <p className="text-gray-600 mb-4">
            Create and manage events, generate invitation cards, and connect
            with vendors.
          </p>
          <Link
            to="/events"
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg">
          ...
          <p className="text-gray-600 mb-4">
            Find and connect with trusted vendors for your events.
          </p>
          <Link
            to="/vendors"
            className="text-indigo-600 font-medium hover:text-indigo-800"
          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-gray-50 rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600 mb-4">
                  Join us for an amazing day of music and fun!
                </p>
                <Link
                  to={`/events/${i}`}
                  className="text-indigo-600 font-medium hover:text-indigo-800"
