    ...
    <Router>
      <MainLayout>
        <Routes>
          ...
          <Route path="/sports/groups/:id" element={<SportGroupDetailsPage />} />
          <Route path="/sports/groups/:id/members" element={<GroupMembersPage />} />
          <Route path="/sports/groups/:id/invite" element={<InviteMemberPage />} />
          <Route path="/sports/groups/:id/game-day" element={<GameDayPage />} />
          <Route path="/sports/groups/:id/live-match" element={<LiveMatchPage />} />
