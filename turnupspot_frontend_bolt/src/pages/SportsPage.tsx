...
const mockSportGroups: SportGroup[] = [
  {
    ...
    venueImage: 'https://images.pexels.com/photos/399187/pexels-photo-399187.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    adminIds: ['1'],
  ...
  },
  {
    ...
    venueImage: 'https://images.pexels.com/photos/114296/pexels-photo-114296.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    adminIds: ['2'],
  ...
  },
  {
    ...
    venueImage: 'https://images.pexels.com/photos/47730/the-ball-stadion-football-the-pitch-47730.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    adminIds: ['3'],
  ...
  },
  {
    ...
    venueImage: 'https://images.pexels.com/photos/274506/pexels-photo-274506.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    adminIds: ['4'],
  ...
  },
  {
    ...
    venueImage: 'https://images.pexels.com/photos/3448250/pexels-photo-3448250.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    adminIds: ['5'],
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center text-gray-500">
                  ...
                  <span>Next game: {
                    group.id === '2' ? 'Wednesday, 6:30PM' :
                    group.id === '1' ? 'Saturday, 2PM' :
                    group.id === '3' ? 'Friday, 7PM' :
                    group.id === '4' ? 'Monday, 6PM' :
                    'Sunday, 4PM'
                  }</span>
                </div>
              </div>
